    ...
    <div class="container-fluid">
      <div class="col-md-12">
        ...
        <div class="alert alert-danger alert-dismissible">
          ...
          <form id="form-input" action="<?=isset($fileExist) ? site_url('dashboard/edit/'.$fileExist[0]->id) : site_url('dashboard/add') ?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"><?=$title?></h3>
            </div>
            <div class="bs-stepper" style="padding-left: 20px; padding-right: 20px">
